    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-72 p-0" align="start" side="top">
                <div className="p-3">
                    <div className="text-sm text-muted-foreground mb-3">ohm-user@example.com</div>
                    ...
                    <div className="space-y-0.5">
                        <button className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-left hover:bg-accent rounded-lg transition-colors">
                    ...
                    <button className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-left hover:bg-accent rounded-lg transition-colors text-destructive">
