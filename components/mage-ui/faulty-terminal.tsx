...
// Main component without memo wrapper (for internal use)
...
// This is critical for performance - the terminal won't re-render when parent re-renders
const FaultyTerminal = React.memo(FaultyTerminalComponent);
