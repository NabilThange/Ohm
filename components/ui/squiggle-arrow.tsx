...
export function SquigglyArrow({
  ...
  const selectedPath = paths[variant as keyof typeof paths] || paths.wavy
  const directionRotation = rotations[direction as keyof typeof rotations] || rotations.right
  ...
  return (
    ...
    >
      ...
      <g transform={directionRotation}>
        ...
        {/* Rounded end if enabled */}
        {roundedEnd && (
          <circle cx="15" cy="50" r={strokeWidth / 2} fill="currentColor" />
        )}
